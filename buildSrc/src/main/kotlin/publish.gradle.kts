        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/aboelela924/offer/")
                    ...
                    developers {
                        developer {
                            id.set("aboelela924")
                            name.set("aboelela924")
                        }
                    }
                    scm {
                        connection.set("scm:git:git://github.com/aboelela924/offer.git")
                        developerConnection.set("scm:git:ssh://github.com/aboelela924/offer.git")
                        url.set("https://github.com/aboelela924/offer/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/aboelela924/offer/issues")
                    }
                }
            }
        }
